...
public class NewOrderPanel extends JPanel {
    private final CustomerMain mainFrame;
    ...
    public NewOrderPanel(CustomerMain mainFrame) {
    ...
    private JPanel createMenuPanel() {
        ...
        menuList.setCellRenderer(new restaurant.customerGUI.NewOrderPanel.MenuItemRenderer());
        menuList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        JScrollPane menuScrollPane = new JScrollPane(menuList);

        selectedItemImageLabel = new JLabel();
        selectedItemImageLabel.setPreferredSize(new Dimension(200, 5));
    ...
    private class MenuItemRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(
            ...
            if (value instanceof MenuItem) {
                ...
                JLabel textLabel = new JLabel(String.format("<html><b>%s</b><br>%.2f S.P<br>%s</html>",
