...
public class DataBaseCustomer {
    ...
    private static final String USERS_FILE = DATA_DIRECTORY + "/customer_users.txt";
    ...
    public static List<MenuItem> loadMenuItems() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                String[] parts = line.split("\\|");
                if (parts.length == 5) {
                    String imagePath = parts.length == 5 ? parts[4] : "";
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (parts[0]) {
                    case "ORDER":
                        ...
                        if (!(Objects.equals(CustomerMain.user, parts[2]) && Objects.equals(parts[3], "USER"))) {
                            continue;
                        }
                    ...
                    case "ITEM":
                        if (currentOrder != null && parts.length == 6) {
                            String imagePath = parts.length == 6 ? parts[5] : "";
    ...
    public static void saveOrder(Order newOrder) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file, true))) {
            writer.write("ORDER|" + newOrder.getOrderId() + "|" + CustomerMain.user + "|USER|" +
